...
set CommonCCompilerFlags=-MT -nologo -Gm- -GR- -EHa -Od -Oi -W4 -wd4201 -wd4100 -wd4189 -wd4505 -Z7 /Fe%BuildFolder% /Fo%BuildFolder%
REM set CommonCCompilerFlags= -nologo -MD -Os /Fe%BuildFolder% /Fo%BuildFolder%
